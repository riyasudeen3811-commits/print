...
<html lang="en">
  ...
  <body>
        ...
        <div class="header-search-container">
          <form class="header-search-form" id="search-form" onsubmit="return false;">
            <div class="search-input-wrapper">
              ...
              <input type="text" class="header-search-input" id="search-input" placeholder=" " aria-label="Search products" autocomplete="off" />
    ...
    <!-- ═══ HERO SECTION — NEW HERO IMAGE & OPTIMIZED SPEED ═══ -->
    <section class="hero" id="home">
      <div class="hero-bg">
        <img src="/hero-bg.jpg" alt="Adha Prints — Premium Business Printing Showcase Chennai" fetchpriority="high" decoding="async" width="1024" height="575" />
      </div>
    ...
    <!-- ═══ POPULAR CATEGORIES CAROUSEL SECTION ═══ -->
    ...
    <!-- ═══ POPULAR PRINTING — AUTO-RUNNING MARQUEE BANNER ═══ -->
    ...
    <!-- ═══ COMPLETE PRINTING SOLUTIONS GRID ═══ -->
    ...
    <!-- ═══ FROM IDEA TO PRINT (WITH VISUAL STEP IMAGES) ═══ -->
    <section class="process-showcase section-padding">
      <div class="container">
        <div class="text-center reveal">
          <div class="accent-line"></div>
          <h2 class="section-title">From Idea to Print</h2>
          <p class="section-subtitle">Our visual 4-step workflow from design concept to precision printed product.</p>
        </div>
        ...
        <div class="process-steps-grid stagger-children">
          ...
          <div class="process-card">
            <div class="process-card-image">
              <img src="/business-cards.jpg" alt="Step 1 Choose Product Specs" loading="lazy" decoding="async" width="600" height="400" />
              <div class="step-num-badge">01</div>
            </div>
            <div class="process-card-content">
              <h3>Choose Product & Specs</h3>
              <p>Select paper GSM (130-350 GSM), size, lamination (Matte, Gloss, Velvet, Spot UV), and quantity.</p>
            </div>
          </div>
          ...
          <div class="process-card">
            <div class="process-card-image">
              <img src="/flyers.jpg" alt="Step 2 Upload or DTP Graphic Design" loading="lazy" decoding="async" width="600" height="400" />
              <div class="step-num-badge">02</div>
            </div>
            <div class="process-card-content">
              <h3>Upload or Get DTP Design</h3>
              <p>Send your print-ready PDF/AI file or collaborate with our Kottivakkam graphic design team.</p>
            </div>
          </div>
          ...
          <div class="process-card">
            <div class="process-card-image">
              <img src="/offset-printing.jpg" alt="Step 3 Heidelberg Press Offset Printing" loading="lazy" decoding="async" width="600" height="400" />
              <div class="step-num-badge">03</div>
            </div>
            <div class="process-card-content">
              <h3>Precision Heidelberg Printing</h3>
              <p>State-of-the-art CMYK offset press machinery with strict color calibration and quality inspection.</p>
            </div>
          </div>
          ...
          <div class="process-card">
            <div class="process-card-image">
              <img src="/brochures.jpg" alt="Step 4 Fast Doorstep Delivery Chennai" loading="lazy" decoding="async" width="600" height="400" />
              <div class="step-num-badge">04</div>
            </div>
            <div class="process-card-content">
              <h3>Fast Express Doorstep Delivery</h3>
              <p>Carefully finished, folded, and packaged products delivered straight to your door across Chennai.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="comparison-container reveal" id="comparison">
          <div class="comparison-after">
            <img src="/business-cards.jpg" alt="Finished Printed Velvet Spot UV Card" loading="lazy" decoding="async" width="900" height="440" />
            <span class="comp-badge badge-after">✨ Finished Printed Output</span>
          </div>
          <div class="comparison-before" id="comparison-before">
            <img src="/letterheads.jpg" alt="Raw Digital Artwork File" loading="lazy" decoding="async" width="900" height="440" />
      ...
      <div class="container">
        <div class="about-grid">
          ...
          <div class="about-image-card reveal-right">
            <img src="/offset-printing.jpg" alt="Adha Prints Offset Machine & Quality Check" loading="lazy" decoding="async" width="600" height="400" />
...
print("Updated index.html with SEO image tags & Process Flow images")
