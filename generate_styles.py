...
css_content = """/* ══════════════════════════════════════════════════════════════════
   ADHA PRINTS — Inspired by theprintguy24.com (Ultra-Premium ₹1L Theme)
   ══════════════════════════════════════════════════════════════════ */
...
/* Header Search Container (like theprintguy24.com) */
...
/* ═══ PROMO BANNERS GRID (3-Column Layout like theprintguy24.com) ═══ */
...
/* ═══ POPULAR CATEGORIES (Underline Title + Carousel) ═══ */
...
.calculator-card .section-subtitle {
  color: #94a3b8;
}
...
@media (max-width: 1024px) {
  .banner-large, .banner-tall, .banner-wide {
    grid-column: span 12;
  }
